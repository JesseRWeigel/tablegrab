...
Bookmarklet that turns any HTML table into CSV, JSON, Markdown or SQL, with colspan and rowspan normalisation

Catalog task: `EXT-003`. One of a public catalog of build ideas: https://github.com/JesseRWeigel/722-things-to-build
